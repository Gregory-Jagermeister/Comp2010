...
public class BTree {
    ...
    private void restock (Node node,  LinkedStack ancestors) {
    ...
    private Node findLeftmostNode (Node top, LinkedStack ancestors) {
    ...
    public String printFlatInorder() {
    	return printFlatInorderSubtree(root);
    }
    
    private static String printFlatInorderSubtree(Node top) {
    	String s = new String();
    	if (top != null) {
    		boolean isLeaf = top.isLeaf();
    		for (int i = 0; i < top.size; i++) {
    			if (!isLeaf)
    				s += printFlatInorderSubtree(top.childs[i]);
    			s += top.items[i];
    		}
    		if (!isLeaf)
    			s += printFlatInorderSubtree(top.childs[top.size]);
    	}
    	return s;
    }
 
    public String printFlatPreorder() {
    	return printFlatPreorderSubtree(root);
    }
    
    private static String printFlatPreorderSubtree(Node top) {
    	String s = new String();
    	if (top != null) {
    		boolean isLeaf = top.isLeaf();
    		for (int i = 0; i < top.size; i++) {
    		...
    		for (int i = 0; i < top.size; i++) {
    			if (!isLeaf)
    				s += printFlatPreorderSubtree(top.childs[i]);
    		}
    		if (!isLeaf)
    			s += printFlatPreorderSubtree(top.childs[top.size]);
    	}
    	return s;
    }
    ...
    public static void main(String[] args) {
    	...
    	System.out.println(bt.printFlatInorder());
    	System.out.println(bt.printFlatPreorder());
    }
